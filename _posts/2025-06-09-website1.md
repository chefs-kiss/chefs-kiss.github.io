...
The rest of the week is going to be spend on getting some diagrams for the ML for Biologist talk in July, and getting together resources for the department workshop on Thursday. I've also tried to add an image to this post for the last 30 minutes to no avail-- something I want to figure out during Thursday's workshop.

Anyway, off to a pilates class tonight with some friends. Hopefully can walk tomorrow :dizzy:
